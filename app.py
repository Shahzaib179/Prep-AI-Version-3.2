...
def render_quiz(conn: sqlite3.Connection, student_id: str) -> None:
    ...
    if st.session_state.get("quiz_submitted"):
        ...
        if st.button("Practice My Weak Topics"):
            ...
            # widget has already been created during this Streamlit run.
            # Store the requested navigation and apply it at the beginning
            # of the next run instead.
            st.session_state["_pending_page"] = "Smart Revision"
...
def main() -> None:
    ...
    # Apply page changes requested by buttons BEFORE the navigation radio widget
    # is created. Streamlit does not allow changing a widget's session-state
    # value after that widget has already been instantiated in the same run.
